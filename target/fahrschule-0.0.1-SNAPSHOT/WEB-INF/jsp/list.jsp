        ...
        <div class="rank_card_jl">
            ...
            <div class="rank_card_body">
                <div class="rank_first">
                    <div class="rank_data">
                        <div class="rank_first_jl">
                            <a href="accompany.html" title="刘宽" target="_blank">
                                <img src="${pageContext.request.contextPath}/statics/images/n_s12705081024140840192_84cb637fcff67c10.jpg" alt="">
                            </a>
                        </div>
                        <div class="info">
                            <div>
                                <div class="info-name"><a href="#://jl.jxedt.com/24008/" title="刘宽" target="_blank">刘宽</a></div>
                                <div class="info-old">6年驾龄</div>
                            </div>
                            <div>
                                <span>所属驾校：富顺久安驾校</span>
                            </div>
                            <div>
                ...
                <ul class="rank_first_jl_ul">
                    <li>
                        <a href="coach.html" title="邱文彬" target="_blank"><div>邱文彬</div>
                            <div><img src="${pageContext.request.contextPath}/statics/images/star@4.png" alt=""></div>
                        </a>
                    </li>
                    <li>
                        <a href="coach.html" title="吾吉才仁" target="_blank"><div>吾吉才仁</div>
                            <div><img src="${pageContext.request.contextPath}/statics/images/star@0.png" alt=""></div>
                        </a>
                    </li>
                    <li>
                        <a href="coach.html" title="张教练" target="_blank"><div>张教练</div>
                            <div><img src="${pageContext.request.contextPath}/statics/images/star@3.png" alt=""></div>
                        </a>
                    </li>
                    <li>
                        <a href="coach.html" title="王春" target="_blank"><div>王春</div>
                            <div><img src="${pageContext.request.contextPath}/statics/images/star@4.png" alt=""></div>
                        </a>
                    </li>
                    <li>
                        <a href="#://jl.jxedt.com/1144104932006223873/" title="张庆国" target="_blank"><div>张庆国</div>
                            <div><img src="${pageContext.request.contextPath}/statics/images/star@3.png" alt=""></div>
                        </a>
                    </li>
                    <li>
                        <a href="#://jl.jxedt.com/1133664464780963841/" title="黄程" target="_blank"><div>黄程</div>
                            <div><img src="${pageContext.request.contextPath}/statics/images/star@0.png" alt=""></div>
                        </a>
                    </li>
                    <li>
                        <a href="#://jl.jxedt.com/21660/" title="李春祥" target="_blank"><div>李春祥</div>
                            <div><img src="${pageContext.request.contextPath}/statics/images/star@4.png" alt=""></div>
                        </a>
                    </li>
                    <li>
                        <a href="#://jl.jxedt.com/1115780427018186754/" title="建国" target="_blank"><div>建国</div>
                            <div><img src="${pageContext.request.contextPath}/statics/images/star@0.png" alt=""></div>
                        </a>
                    </li>
                    <li>
                        <a href="#://jl.jxedt.com/20516/" title="肖小姐" target="_blank"><div>肖小姐</div>
                            <div><img src="${pageContext.request.contextPath}/statics/images/star@4.png" alt=""></div>
                        </a>
                    </li>
                </ul>
