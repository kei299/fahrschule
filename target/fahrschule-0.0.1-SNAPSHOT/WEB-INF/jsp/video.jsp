	...
	<body>
			...
			<nav class="comment-header-nav">
				...
				<div class="comment-header-contact">
					<div class="comment-header-left">
						...
						<div class="comment-login-1" style="display:inline-block;">
							...
							<span class="btn-span"><a href="${pageContext.request.contextPath}/login/studentLogin" onclick="clickLog('from=JXEDT_HEADER_LOGIN')">登录</a></span>
							<span class="btn-span"><a href="${pageContext.request.contextPath}/login/studentRegistration"" target="_blank" onclick="clickLog('from=JXEDT_HEADER_SIGNIN')">注册</a></span>
						</div>
					</div>
				...
				<div class=" comment-header-search">
					...
					<div class="comment-header-search-position">
						...
						<span class="comment-header-city" name="全国">全国</span> <span>[切换城市]</span> </a>
						<!-- 城市选择弹出框开始 -->
					...
					<div class="comment-header-search-text">
						...
						<ul class="search-content-toggle">
							<li class="dropdown">
								<a href="${pageContext.request.contextPath}/drivingSchool/fahrschule" data-search-type="jiaxiao" class="dropdown-toggle" id="tutorial">驾校
									<div class="down"></div>
								</a>
								<ul class="dropdown-menu" style="display: none;">
									<li>
										<a data-search-type="jiaxiao" href="${pageContext.request.contextPath}/drivingSchool/fahrschule">驾校</a>
									</li>
									<li>
										<a data-search-type="jl" href="${pageContext.request.contextPath}/coach/home">教练</a>
									</li>
									<li>
				...
				<div>
					<div class="comment-header-menu">
						<ul class="comment-header-menu-ul">
							...
							<li>
								<a href="${pageContext.request.contextPath}/drivingSchool/fahrschule" linkrul="jiaxiao" data-track="JXEDT_HTAB_JX" onclick="linkclick(this)" style="color: rgb(74, 74, 74);">驾校</a>
							</li>
							<li>
								<a href="${pageContext.request.contextPath}/coach/home" linkrul="jl" data-track="JXEDT_HTAB_JL" onclick="linkclick(this)" style="color: rgb(74, 74, 74);">教练</a>
							</li>
							<li>
		...
		<div class="video-page">
			<div class="video-main">
				<p>位置：
					<a href="${pageContext.request.contextPath}/video/index">学车视频</a>
				</p>
				<!-- 学车视频左侧 -->
				<div class="video-left">
						...
						<div class="video-left-top-t">
							<ul>
								<li>
									...
									<a class="select-text" target="_blank" timem="00:01:39" photom="${pageContext.request.contextPath}/statics/images/v100008.jpg" urlid="938029173006297477" href="${pageContext.request.contextPath}/video/videoPlayback?videoId=2">上车准备</a>
								</li>
								<li>
									<div class="circle"></div>
									<a class="select-text" target="_blank" timem="00:05:38" photom="${pageContext.request.contextPath}/statics/images/v100002.jpg" urlid="938029173019238620" href="${pageContext.request.contextPath}/video/videoPlayback?videoId=2">倒车入库</a>
								</li>
								<li>
									<div class="circle"></div>
									<a class="select-text" target="_blank" timem="00:04:46" photom="${pageContext.request.contextPath}/statics/images/v100001.jpg" urlid="938029173024731542" href="${pageContext.request.contextPath}/video/videoPlayback?videoId=2">侧方停车</a>
								</li>
								<li>
									<div class="circle"></div>
									<a class="select-text" target="_blank" timem="00:04:30" photom="${pageContext.request.contextPath}/statics/images/v100006.jpg" urlid="938029173036271906" href="${pageContext.request.contextPath}/video/videoPlayback?videoId=2">坡路定点停车与起步</a>
								</li>
								<li>
									<div class="circle"></div>
									<a class="select-text" target="_blank" timem="00:01:28" photom="${pageContext.request.contextPath}/statics/images/v100011.jpg" urlid="938029173019325656" href="${pageContext.request.contextPath}/video/videoPlayback?videoId=2">上车准备</a>
								</li>
								<li>
									<div class="selected-circle"></div>
									<a class="select-text selected-text" target="_blank" timem="00:02:43" photom="${pageContext.request.contextPath}/statics/images/v100012.jpg" urlid="938029173004829588" href="${pageContext.request.contextPath}/video/videoPlayback?videoId=2">模拟夜间场景灯光使用</a>
								</li>
							</ul>
						</div>
					</div>
					<div class="video-left-bottom" id="jinxuan">
						<ul class="car-video">
							<li>
								<a class="active" href="javascript:;" onclick="getListByType(0)">精选推荐</a>
							</li>
							<li>
								<a href="javascript:;"  onclick="getListByType(1)">科目一</a>
							</li>
							<li>
								<a href="javascript:;"  onclick="getListByType(2)">科目二</a>
							</li>
							<li>
								<a href="javascript:;"  onclick="getListByType(3)">科目三</a>
							</li>
							<li>
								<a href="javascript:;"  onclick="getListByType(4)">科目四</a>
							</li>
							<li>
								<a href="javascript:;"  onclick="getListByType(5)">拿本</a>
							</li>
						</ul>
						<div class="car-video-border"></div>
						<div class="car-video-list">
							<div class="mediawarp">
								<input type="hidden" id="RecMediaTotal" value="2" />
								<input type="hidden" id="RecMediaNext" value="2" />
								<input type="hidden" id="totalPage" />
								<input type="hidden" id="pageFlag" />
								<div id="videoList"></div>
								<%-- <c:forEach items="${pg.list}" var="video" >
									<div class="car-video-list-detail">
										<a target="_blank" href="${pageContext.request.contextPath}/video/videoPlayback?videoId=${video.videoId}">
											<div class="video-img">
												<div class="video-play"></div>
												<div class="floating-layer">
													<span>${video.videoTime}</span>
												</div>
												<img src="${pageContext.request.contextPath}/statics/images/${video.videoImge}" alt="" />
											</div>
											<div class="video-describe">
												...
												<div class="video-time">
													<div class="play-back">
														...
														<span class="num">${video.numViews}</span>
													</div>
													<div class="thumbs-up">
														<span class="thumbs-up-img"></span>
														<span class="thumbs-up-num">${video.pointRatio}</span>
													</div>
												</div>
											</div>
										</a>
								...
								<div class="video-list-page">
									<div class="list-pagjse-wrap">
										<div id="pagination_video"></div>
									</div>
								</div>
							</div>
						</div>
				...
				<div class="video-right">
					<div class="video-right-top">
						...
						<ul>
							<input type="hidden" id="playTopTotal" value="10" />
							<input type="hidden" id="playTopNext" value="10" />
