        ...
        <div class="header-wrap">
            <div class="header-nav">
                <div class="left-nav">
                    <%--LOGO-主页链接--%>
                    <div class="logo-img">
                        <a href="${pageContext.request.contextPath}/drivingSchool/list">
        ...
        <article class="login-guide-main">
            <div class="jx-register">
                ...
                <div class="register-form jx-register-form">
                    <form action="${pageContext.request.contextPath}/coach/personal" autocomplete="off" id="registerfrom">
                        <h4>教练入驻</h4>
                        <div class="div-wrap">
                        ...
                        <div>
                            <label for="register_checkbox">
                                ...
                                <span>我已阅读并接受<a href="#" target="_blank">《注册条款》</a></span>
                            </label>
                        </div>
                    </form>
                </div>
