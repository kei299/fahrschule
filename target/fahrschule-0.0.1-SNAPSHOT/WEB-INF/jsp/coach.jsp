...
<html>
<meta name="baidu-site-verification" content="BfqtlYaq09">
<title>全国教练-绿翔驾考</title>
<meta name="keywords" content="全国驾校教练,全国驾校教练员,全国学车教练">
<meta name="description" content="绿翔全国驾校教练频道为您精选优质的全国驾校教练员,良好的服务态度和多年驾驶经验,为学员提供手把手的指导.全国好教练教练车,下本快!">	    <meta http-equiv="”Cache-Control”" content="”no-transform”">
<!--原有seo等等结束-->
...
<link rel="stylesheet" href="${pageContext.request.contextPath}/statics/css/jllist_all.css">
...
<style type="text/css">
    .BMap_mask{background:transparent url(#api0.map.bdimg.com/${pageContext.request.contextPath}/statics/images/blank.gif);}
    .BMap_noscreen{display:none;}.BMap_button{cursor:pointer;}
    .BMap_zoomer{background-image:url(http://api0.map.bdimg.com/images/mapctrls1d3.gif);background-repeat:no-repeat;overflow:hidden;
        font-size:1px;position:absolute;width:7px;height:7px;}
    ...
    .BMap_ie6 .BMap_smcbg{left:0;width:44px;height:464px;filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src="http://api0.map.bdimg.com/images/mapctrls2d0.png");}
    .BMap_ie6 .BMap_stdMpPanBg{z-index:-1;}  .BMap_stdMpPan .BMap_button{height:15px;width:15px;}  .BMap_panN,.BMap_panW,.BMap_panE,.BMap_panS{overflow:hidden;}
    .BMap_panN{left:14px;top:0;}.BMap_panW{left:1px;top:12px;}.BMap_panE{left:27px;top:12px;}  .BMap_panS{left:14px;top:25px;}.BMap_stdMpZoom{top:45px;overflow:hidden;}
    ...
    .BMap_ie6 .BMap_stdMpZoom .BMap_button{background:none;}  .BMap_stdMpZoomIn{background-position:0 -221px;}.BMap_stdMpZoomOut{background-position:0 -265px;}
    .BMap_ie6 .BMap_stdMpZoomIn div{left:0;top:-221px;}.BMap_ie6 .BMap_stdMpZoomOut div{left:0;top:-265px;}
    .BMap_stdMpType4 .BMap_stdMpZoom .BMap_button{left:0;overflow:hidden;background:-webkit-gradient(linear,50% 0,50% 100%,from(rgba(255,255,255,0.85)),to(rgba(217,217,217,0.85)))
    ;z-index:10;-webkit-border-radius:22px;width:34px;height:34px;border:1px solid rgba(255,255,255,0.5);
        -webkit-box-shadow:0 2px 3.6px #CCC;display:-webkit-box;-webkit-box-align:center;-webkit-box-pack:center;
    ...
    .BMap_ie6 .BMap_stdMpSliderBgTop div{left:-23px;top:-226px;}.BMap_ie6 .BMap_stdMpSliderBgBot div{left:-33px;bottom:0;}
    ...
    .BMap_ie6 .BMap_stdMpSliderBar,.BMap_ie6 .BMap_stdMpSliderBar.h{background:none;}.BMap_ie6 .BMap_stdMpSliderBar div{top:-309px;}
    ...
    .BMap_zlHolder{display:none;position:absolute;top:0;}.BMap_zlHolder.hvr{display:block;}
    .BMap_zlSt{background-position:0 -380px;top:21px;}.BMap_zlCity{background-position:0 -401px;top:52px;}
    .BMap_zlProv{background-position:0 -422px;top:76px;}.BMap_zlCountry{background-position:0 -443px;top:100px;}
    .BMap_ie6 .BMap_zlSt div{top:-380px;}.BMap_ie6 .BMap_zlCity div{top:-401px;}.BMap_ie6 .BMap_zlProv div{top:-422px;}  .BMap_ie6 .BMap_zlCountry div{top:-443px;}
    .BMap_stdMpType1 .BMap_stdMpSlider,.BMap_stdMpType2 .BMap_stdMpSlider,.BMap_stdMpType3 .BMap_stdMpSlider,.BMap_stdMpType4 .BMap_stdMpSlider,.BMap_stdMpType2
    .BMap_stdMpZoom,.BMap_stdMpType3 .BMap_stdMpPan,.BMap_stdMpType4 .BMap_stdMpPan{display:none;}
    .BMap_stdMpType3 .BMap_stdMpZoom{top:0;}.BMap_stdMpType4 .BMap_stdMpZoom{top:0;}  .BMap_cpyCtrl a{font-size:11px;color:#7979CC;}.BMap_scaleCtrl{height:23px;overflow:hidden;}
    .BMap_scaleCtrl div.BMap_scaleTxt{font-size:11px;font-family:Arial,sans-serif;}  .BMap_scaleCtrl div{position:absolute;overflow:hidden;}
    .BMap_scaleHBar img,.BMap_scaleLBar img,.BMap_scaleRBar img{position:absolute;width:37px;height:442px;left:0;}
    .BMap_scaleHBar{width:100%;height:5px;font-size:0;bottom:0;}.BMap_scaleHBar img{top:-437px;width:100%;}
    .BMap_scaleLBar,.BMap_scaleRBar{width:3px;height:9px;bottom:0;font-size:0;z-index:1;}.BMap_scaleLBar img{top:-427px;left:0;}
    .BMap_scaleRBar img{top:-427px;left:-5px;}.BMap_scaleLBar{left:0;}.BMap_scaleRBar{right:0;}
    .BMap_scaleTxt{text-align:center;width:100%;cursor:default;line-height:18px;}
    .BMap_omCtrl{background-color:#fff;overflow:hidden;}.BMap_omOutFrame{position:absolute;width:100%;height:100%;left:0;top:0;}
    ...
    .BMap_omViewInnFrame{border:1px solid #3e6bb8;}.BMap_omViewMask{width:1000px;height:1000px;position:absolute;left:0;top:0;background-color:#68c;opacity:.2;filter:progid:DXImageTransform.Microsoft.Alpha(opacity=20);}
    ...
    .quad4 .BMap_omBtn{background-position:-26px -27px;}.quad4 .BMap_omBtn.hover{background-position:0 -27px;}
    .quad4 .BMap_omBtn.BMap_omBtnClosed{background-position:-39px -27px;}  .quad4 .BMap_omBtn.BMap_omBtnClosed.hover{background-position:-13px -27px;}
    .anchorTR .BMap_omOutFrame{border-bottom:1px solid #999;border-left:1px solid #999;}
    .quad1 .BMap_omBtn{background-position:-39px -41px;}.quad1 .BMap_omBtn.hover{background-position:-13px -41px;}
    .quad1 .BMap_omBtn.BMap_omBtnClosed{background-position:-26px -41px;}  .quad1 .BMap_omBtn.BMap_omBtnClosed.hover{background-position:0 -41px;}
    .anchorBL .BMap_omOutFrame{border-top:1px solid #999;border-right:1px solid #999;}
    .quad3 .BMap_omBtn{background-position:-27px -40px;}.quad3 .BMap_omBtn.hover{background-position:-1px -40px;}
    ...
    .quad2 .BMap_omBtn{background-position:-40px -28px;}.quad2 .BMap_omBtn.hover{background-position:-14px -28px;}
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $("#goBtn").click(function(){
            ...
            if(parseInt(jumpPage) > 0 && parseInt(jumpPage) <= totalPage){
                //跳转至输入的页码页面
                window.location.href = "${pageContext.request.contextPath}/coach/home?pageNo="+jumpPage;
            }else{
                alert("请输入正确的页码");
            }
        })
        ...
        $("#firstPage").click(function(){
            ...
            $("#pageNo").val(1);
            //提交表单查询
            window.location.href = "${pageContext.request.contextPath}/coach/home?pageNo="+1;
        })
        ...
        $("#prePage").click(function(){
            ...
            //提交表单查询
            window.location.href = "${pageContext.request.contextPath}/coach/home?pageNo="+prePageNo;
        })
        ...
        $("#nextPage").click(function(){
            ...
            //提交表单查询
            window.location.href = "${pageContext.request.contextPath}/coach/home?pageNo="+nexPageNo;
        })

        $("#lastPage").click(function(){
            //改变pageNo位1
            var lastPageNo = parseInt($("#totalPage").val());
            //提交表单查询
            window.location.href = "${pageContext.request.contextPath}/coach/home?pageNo="+lastPageNo;
        })

        $("#search").click(function(){
            var select = $("#select").val();
            var condition = $("#condition").val();
            window.location.href = "${pageContext.request.contextPath}/coach/home?condition="+condition+"&type="+select;

        })
        /*进入教练个人页面*/
        $(".VcoachHead").click(function () {
            var coachId = $("this+.VcoachId").val();
            alert(coachId);
            window.location.href = "${pageContext.request.contextPath}/coach/doClass?coachId="+coachId;
        })
    })
...
<div class="jll-wrap">
    ...
    <div class="position-type-value">
                                <a data-track="JXEDT_JLLB_KOBEI_PX" class="position-type-value-each" href="javascript:void(0)" onclick="window.location.href=&#39;/ord_kbzs.html&#39;">
            <font>口碑</font>
            <div class="up"></div>
            <div class="down"></div>
        </a>
                        <a data-track="JXEDT_JLLB_JIAGE_PX" class="position-type-value-each" href="javascript:void(0)" onclick="window.location.href=&#39;/ord_pd.html&#39;">
            <font>价格</font>
            <div class="up"></div>
            <div class="down"></div>
        </a>
                        <a data-track="JXEDT_JLLB_RENQI_PX" class="position-type-value-each" onclick="window.location.href=&#39;/ord_click.html&#39;"><font>人气</font>
            <div class="up"></div>
            <div class="down"></div>
        </a>
            </div>
			...
			<div class="list-warp">
				<!-- 教练列表 -->
<div class="list-warp">
    <c:forEach items="${pg.list}" var="coach" varStatus="status" >
    <div class="list-each">
        <div class="list-img">
            <%--点头像进入个人页面--%>
            <a  target="_blank" href="${pageContext.request.contextPath}/coach/doIntro?coachPhone=${coach.coachPhone}">
                <img src="${coach.coachHead}" alt="驾校">
            </a>
        </div>
        <div class="list-info">
            <div class="info-top">
                <%--点名字进入个人页面--%>
                <div class="info-name"><a target="_blank" href="${pageContext.request.contextPath}/coach/doIntro?coachPhone=${coach.coachPhone}">${coach.coachName}</a></div>
                <div class="info-old">${coach.coachYear}年教龄</div>
                <div class="info-img">
                    <%--<span class="JPLListRZ"/>--%>
            ...
            <div class="info-score">
                <img src="http://106.15.74.37/files/coach/all_star.png" alt="">
                <img src="http://106.15.74.37/files/coach/all_star.png" alt="">
                <img src="http://106.15.74.37/files/coach/all_star.png" alt="">
                <img src="http://106.15.74.37/files/coach/all_star.png" alt="">
                <img src="http://106.15.74.37/files/coach/all_star.png" alt="">
                <span class="comment-num">点评${coach.scoreNum}条</span>
            </div>
        </div>
        <div class="list-prize">
            <div class="prize-money">¥${coach.charge}</div>
    ...
    <div class="page-warp">
        <div class="page-item">
            ...
            <c:if test="${pg.pageNo>1}">
                <a class="page-btn active" id="firstPage" href="javascript:void(0)">首页</a>
                <a class="page-btn" id="prePage" href="javascript:void(0)">&lt;</a>
            </c:if>
            跳<input type="text" size="2" id="jumpPage" value="" />页
            <input type="button" id="goBtn" value="go"/>
            <input type="hidden" id="totalPage" value="${pg.totalPage}" />
            <c:if test="${pg.pageNo<pg.totalPage}">
                <a class="page-btn"  id="nextPage" href="javascript:void(0)" >&gt;</a>
                <a class="page-btn active" id="lastPage" href="javascript:void(0)">尾页</a>
            </c:if>
            第${pg.pageNo}/${pg.totalPage}页 共${pg.totalCount}条记录
        </div>
    </div>
</div>
		...
		<div class="pop">
			...
			<form id="subForm" name="form" method="post" action="http://signupnew/add">
...
<div class="left-layer">
    <img src="images/left-layer.png">
</div>
<ul class="right-nav-common">
    <li class="downApp">
        <a target="_blank" href="./list.htmlabout">
            <div class="downApp-icon"></div>
        </a>
        <div class="downApp-alert"></div>
    </li>
    <li class="opinion">
        <a target="_blank" href="./list.htmlabout/index.asp">
            <div class="opinion-icon"></div>
        </a>
        <div class="opinion-alert"><a target="_blank" href="./list.htmlabout/index.asp">意见反馈</a></div>
    </li>
    <li class="service">
        ...
        <div class="table">
            <div class="counter">
                <div class="person-wrap">
                    <img src="images/zhangyishan-fx.png" alt="">
                </div>
                <div class="left">
                    <p>驾考计算器</p>
                    <div class="infobox">
                ...
                <div class="right">
                    ...
                    <div class="goto">
                        <a href="http://jiaxiao.jxedt.com/" onclick="clickLog(&#39;from=JXEDT_FUCENG_QTJXBJ&#39;)">去看看驾校报价</a>
                    </div>
                </div>
                <div class="counterclose">
                    <img src="images/counterclose.png">
                </div>
            </div>
        </div>
    </div>
