...
<title>驾校一点通</title>
<meta name="keywords" content="教练,富顺久安驾校教练名单,富顺久安驾校教练约车补训,教练车">
<meta name="description" content="富顺久安驾校刘宽，教练直招，直接上车，不用排队。态度亲和，技术靠谱，下本快！欢迎各位学员报名！">
...
<script src="./js/hm.js"></script><script src="${pageContext.request.contextPath}/statics/js/jquery.1.12.4.js"></script>
...
<style>
    #mpiv-bar {
        position:fixed;z-index:2147483647;left:0;right:0;top:0;transform:scaleY(0);
        -webkit-transform:scaleY(0);transform-origin:top;
        -webkit-transform-origin:top;transition:transform 500ms ease 1000ms;
    ...
    #mpiv-popup {
        display:none;border:1px solid gray;box-sizing:content-box;background-color:white;
        position:fixed;z-index:2147483647;margin:0;max-width:none;max-height:none;
        will-change:display,width,height,left,top;cursor:none;
    }
    ...
    .mpiv-ready *, .mpiv-large * {
        cursor:zoom-in!important; cursor:-webkit-zoom-in!important;
    }
    .mpiv-shift * {
...
<div class="detail-nav">
	...
	<div class="detail-info">
        ...
        <div class="info-school">
			<img src="./images/small_house.png" alt="">
			所属驾校：
            <a href="http://jiaxiao.jxedt.com/3097849987363962996/" target="_blank">${coach.fahrschuleName}</a>
        </div>
    ...
    <div class="tab-content-each tc-info">
        ...
        <table>
            ...
            <tr class="tc-info-class-each">
                ...
                <td>
                    <div class="tc-each-sign"><span><a href="${pageContext.request.contextPath}/coach/doSeek?coachPhone=${coach.coachPhone}">报名咨询</a></span></div></td>
            </tr>
            </tbody>
        </table>
