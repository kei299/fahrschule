...
/**
 * @description ActiveMQ工具类   P2P点对点模式
 * @author admin
...
public class ActiveMQUtil {
    ...
    // Queue名称
    public static final String QUEUENAME_1 = "queue1";
     ...
     * @throws JMSException
     */
    public MessageProducer getMessageProducer(Session session,String queueName) throws JMSException{
        //创建一个到达的目的地，activemq不可能同时只能跑一个队列，这里就是连接了一个名为QUEUENAME的队列，这个会话将会到这个队列，当然，如果这个队列不存在，将会被创建
     ...
     * @throws JMSException
     */
    public MessageConsumer getMessageConsumer(Session session,String queueName) throws JMSException{
        //消息目的地
        Destination destination = session.createQueue(queueName);
