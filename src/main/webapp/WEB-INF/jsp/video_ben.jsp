				...
				<div class="video-left">
					...
					<div class="video-left-bottom" id="jinxuan">
						...
						<div class="car-video-list">
							<div class="mediawarp">
								<input type="hidden" id="nbMediaTotal" value="1">
								<input type="hidden" id="nbMediaNext" value="1">
								<div class="car-video-list-detail">
									<a target="_blank" href="video_playback.jsp">
										<div class="video-img">
											...
											<img src="${pageContext.request.contextPath}/statics/images/welfare.jpg" alt="">
										</div>
										<div class="video-describe">
											...
											<div class="video-time">
												...
												<div class="thumbs-up">
													...
													<span class="thumbs-up-num">4098</span>
												</div>
											</div>
										</div>
									</a>
								...
								<div class="car-video-list-detail">
									<a target="_blank" href="video_playback.jsp">
										<div class="video-img">
											...
											<img src="${pageContext.request.contextPath}/statics/images/v90004.jpg" alt="">
										</div>
										<div class="video-describe">
											<div class="video-text">
												关爱篇
											...
											<div class="video-time">
												<div class="play-back">
													<span class="play"></span>
													<span class="num">167.1万</span>
												</div>
												<div class="thumbs-up">
													<span class="thumbs-up-img"></span>
													<span class="thumbs-up-num">4450</span>
												</div>
											</div>
										</div>
									</a>
								...
								<div class="car-video-list-detail">
									<a target="_blank" href="video_playback.jsp">
										<div class="video-img">
											...
											<img src="${pageContext.request.contextPath}/statics/images/v90005.jpg" alt="">
										</div>
										<div class="video-describe">
											<div class="video-text">
												通报篇
											...
											<div class="video-time">
												<div class="play-back">
													<span class="play"></span>
													<span class="num">128.5万</span>
												</div>
												<div class="thumbs-up">
													<span class="thumbs-up-img"></span>
													<span class="thumbs-up-num">2432</span>
												</div>
											</div>
										</div>
									</a>
								...
								<div class="car-video-list-detail">
									<a target="_blank" href="video_playback.jsp">
										<div class="video-img">
											...
											<img src="${pageContext.request.contextPath}/statics/images/v90006.jpg" alt="">
										</div>
										<div class="video-describe">
											<div class="video-text">
												教育篇
											...
											<div class="video-time">
												<div class="play-back">
													<span class="play"></span>
													<span class="num">153.4万</span>
												</div>
												<div class="thumbs-up">
													<span class="thumbs-up-img"></span>
													<span class="thumbs-up-num">2395</span>
												</div>
											</div>
										</div>
									</a>
